...
const HomeForm = () => {
  return (
    <div className="w-full py-10">
      <div className="md:w-[80%] mx-auto grid md:grid-cols-3 gap-10">
        <div className=" col-span-1">
          <img src={Date} alt="svg" className="" />
        </div>
        <div className=" col-span-2 shadow rounded border">
          <div className="px-5">
            <h3 className=" capitalize font-medium text-xl text-center py-7">Make your Reservation now.</h3>
            <form className="grid md:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-8 mb-3">
